...
void create_label_information(char** group_buffer){
...
void print_process_information(char** group_buffer){
    WINDOW* menu_win;
    int highlight=1;
  ...
  //  attron(A_REVERSE | PAIR_NUMBER(5));                                    //evidenzia la stringa sottostante
    ...
    create_label_information(group_buffer);
...
int main(int argc, char** argv){
    ...
    print_process_information(group_buffer);
